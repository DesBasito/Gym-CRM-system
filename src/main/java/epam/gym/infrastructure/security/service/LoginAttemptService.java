...
import epam.gym.infrastructure.security.model.LoginAttemptDetails;
...
public class LoginAttemptService {
    ...
    public void loginFailed(String username) {
        LoginAttemptDetails details = loginAttempts.computeIfAbsent(username, k -> new LoginAttemptDetails(0));
        ...
        if (details.getAttempts() >= MAX_ATTEMPTS) {
            details.block();
            log.warn("User {} has been blocked due to {} failed login attempts", username, details.getAttempts());
        }
    }
