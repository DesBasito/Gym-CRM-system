package epam.gym.cucumber.integration.steps;
...
import static epam.gym.config.RabbitMQConfig.WORKLOAD_EXCHANGE;
import static epam.gym.config.RabbitMQConfig.WORKLOAD_ROUTING_KEY;
...
public class WorkloadIntegrationStepDefs {
    ...
    @Autowired
    private IntegrationSharedContext context;
    ...
    public void aWorkloadAddMessageWasSentForTrainer(String trainerUsername, int duration) {
    ...
    @Given("I reset workload message tracking")
    public void iResetWorkloadMessageTracking() {
        reset(rabbitTemplate);
    }
